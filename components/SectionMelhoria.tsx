  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h2 className="text-xl font-bold text-gray-900">Não Conformidades e Ações Corretivas (10.2)</h2>
            <p className="text-sm text-gray-500 mt-1">Gestão de desvios e planos de ação para melhoria contínua.</p>
        </div>
        <div className="flex gap-2">
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-isotek-600 text-white text-sm font-medium rounded-lg hover:bg-isotek-700 transition-colors shadow-sm">
                <Plus size={16} />
                Nova RNC
            </button>
        </div>
